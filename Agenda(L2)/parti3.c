...
t_recherchecontact Recherche(t_agenda *agenda, char *nom, char *prenom, int log) {//paramètre int log pour savoir si enregistrer log ou pas dans la recherche
  t_recherchecontact r; // structure de retour de la fonction pour avoir les bornes pour ajouter le contact en cas de valeur non trouvée et le niveau pour créer le contact
  ...
  clock_t debut, fin; // Variable pour stocker les temps d'éxécution des recherches
  char time_lvl0[15];
